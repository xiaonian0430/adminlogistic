...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="/Public/style_HUI/img/profile_small.jpg" /></span>
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold"><?php echo $u_name;?></strong></span>
                                <span class="text-muted text-xs block"><?php echo $u_role_name;?><b class="caret"></b></span>
                                </span>
                            </a>
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li class="divider"></li-->
                                <li>
									<a href="<?php echo U('index/login/out');?>">安全退出</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li>
                        <a class="J_menuItem" href="<?php echo U('index/index/index_v3');?>">
							<i class="fa fa-dashboard"></i>
							<span class="nav-label">仪表盘</span>
						</a>
                    </li>
					<li>
                        <a href="<?php echo U('index/index/yundan');?>">
                            <i class="fa fa-truck"></i>
                            <span class="nav-label">运单管理</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo U('index/index/yundan_v2');?>">列表详情</a>
                            </li>
                            <!--li>
                                <a class="J_menuItem" href="javascript:alert('暂无');">运单地图</a>
                            </li-->
                        </ul>
                    </li>
					<!--li>
                        <a href="#">
                            ...
                            <span class="nav-label">报警</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="graph_echarts.html">监控报警</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="graph_flot.html">超15天报警</a>
                            </li>
                        </ul>
                    </li>
					<li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="bb.html">报表1</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="bb2.html">报表2</a>
                            </li>
                        </ul>
                    </li-->
					<li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo U('index/user/user');?>">系统用户</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo U('index/user/staffmap');?>">业务员地图</a>
                            </li>
                        </ul>
                    </li>
					<?php if($u_role_code == 'R10' or $u_role_code == 'R11'): ?><li>
                        <a href="#">
                            <i class="fa fa-users"></i>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo U('index/info/area');?>">地州信息</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo U('index/info/wangdian');?>">网点信息</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo U('index/info/wlgs');?>">物流公司</a>
                            </li>
							<li>
                                <a class="J_menuItem" href="<?php echo U('index/info/gys');?>">供应商信息</a>
                            </li>
                        </ul>
                    </li><?php endif; ?>
					...
					<!--li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="graph_echarts.html">APP框架版本管理</a>
                            </li>
							<li>
                                <a class="J_menuItem" href="graph_echarts.html">APP-H5模板配置</a>
                            </li>
							<li>
                                <a class="J_menuItem" href="graph_echarts.html">APP-H5数据配置</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="graph_flot.html">版本更新推送</a>
                            </li>
                        </ul>
                    </li-->
                    <!-- <li>
            ...
            <div class="row content-tabs">
                ...
                <nav class="page-tabs J_menuTabs">
                    <div class="page-tabs-content">
                        <a href="javascript:;" class="active J_menuTab" data-id="index_v3.html">仪表盘</a>
                    </div>
                </nav>
                ...
                <a href="<?php echo U('index/login/out');?>" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
            </div>
           <div class="row J_mainContent" id="content-main">
                <!--iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="index_v3.html" frameborder="0" data-id="index_v3.html" seamless></iframe-->
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<?php echo U('index/index/index_v3');?>" frameborder="0" data-id="index_v3" seamless></iframe>
            </div>
            <div class="footer" style="background-color:white;order-top: 1px solid #999999;">
                <div class="pull-right">&copy; <a href="http://www.zi-han.net/" target="_blank">飞云科技</a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
    ...
    <script src="/Public/style_HUI/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="/Public/style_HUI/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="/Public/style_HUI/js/plugins/layer/layer.min.js"></script>
    <script src="/Public/style_HUI/js/hplus.min.js?v=4.1.0"></script>
    <script src="/Public/style_HUI/js/contabs.min.js"></script>
    <script src="/Public/style_HUI/js/plugins/pace/pace.min.js"></script>
</body>
